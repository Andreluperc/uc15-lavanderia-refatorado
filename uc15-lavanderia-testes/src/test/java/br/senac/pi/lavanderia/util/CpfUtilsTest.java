...
class CpfUtilsTest {
    ...
    void isValidoBasico_deve_rejeitar_nulo_ou_tamanho_incorreto() {
        ...
        assertFalse(CpfUtils.isValidoBasico("123.456.789-0")); // 10 digitos
    }
    ...
    void isValidoBasico_deve_rejeitar_todos_digitos_iguais() {
        ...
        assertFalse(CpfUtils.isValidoBasico("999.999.999-99"));
    }

    @Test
    void isValidoBasico_deve_aceitar_formato_com_11_digitos_e_nao_uniforme() {
